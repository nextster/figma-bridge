...
- `plugins/figma-bridge/` is the canonical Codex and Claude Code plugin source. Its `.mcp.json` points to the relay; `npm run setup` installs local-mode copies with absolute stdio paths.
